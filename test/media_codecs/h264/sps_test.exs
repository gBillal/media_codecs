defmodule MediaCodecs.H264.SPSTest do
  ...
  describe "SPS parsing" do
    test "parses a valid SPS NAL unit" do
      sps_data =
        <<0x66, 0x64, 0x00, 0x1F, 0xAC, 0xD9, 0x40, 0x50, 0x05, 0xBB, 0x01, 0x6C, 0x80, 0x00, 0x00,
    ...
    test "sps with scaling list" do
      sps_data =
        <<102, 100, 0, 50, 173, 132, 1, 12, 32, 8, 97, 0, 67, 8, 2, 24, 64, 16, 194, 0, 132, 59, 80,
          20, 0, 90, 211, 112, 16, 16, 20, 0, 0, 3, 0, 4, 0, 0, 3, 0, 162, 16>>
    ...
    test "sps with frame cropping" do
      sps_data =
        <<0x66, 0x42, 0xC0, 0x28, 0xD9, 0x00, 0x78, 0x02, 0x27, 0xE5, 0x84, 0x00, 0x00, 0x03, 0x00,
